...
Replaces the User-only GetUserInfo with one type-tagged tool covering
User / Bot / BroadcastChannel / Supergroup / LegacyChat. DB-first cache
with 5-minute TTL on the daemon side; tool itself is the formatter.
"""
