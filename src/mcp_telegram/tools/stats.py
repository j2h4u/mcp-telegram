...
GET_USAGE_STATS_OUTPUT_SCHEMA = {
    ...
    "properties": {
        ...
        "capability_distribution": {"type": "object"},
        "contract_distribution": {"type": "object"},
...
def _usage_structured_content(stats: dict, *, summary: str, empty: bool) -> dict[str, object]:
    ...
    return {
        ...
        "capability_distribution": stats.get("capability_distribution") or {},
        "contract_distribution": stats.get("contract_distribution") or {},
