...
| `list_important_events` | Important Events | primary | true | n/a | yes | compact recent important event journal for access lifecycle events and future mentions/replies/reactions | `timezone`, `last_hours`, `events[] {time,time_basis,type,summary,dialog_id,dialog_title,message_id}` | none |
